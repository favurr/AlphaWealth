...
export default async function HistoryPage() {
  ...
  if (!session?.user?.id) {
    return <p className="text-center py-20">You must be logged in to view your history.</p>;
  }
  ...
  if (!history.length) {
    return (
      <div className="text-center py-20 text-muted-foreground">
        ...
        <p className="mt-2">All your deposits, transfers, and withdrawals will appear here.</p>
      </div>
    );
  }
