  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background flex items-center justify-center px-4">
      ...
      {floatingGears.map((_, i) => (
        <motion.div
          key={i}
          className="absolute h-32 w-32 rounded-full border-2 border-dashed border-white "
          initial={{
      ...
      >
        ...
        <div className="relative mx-auto mb-6 h-24 w-24">
          ...
          />
          <motion.div
            className="absolute inset-4 rounded-full border border-white"
            animate={{ rotate: -360 }}
        ...
        <p className="mt-3 text-sm text-white-foreground leading-relaxed">
          Systems are actively moving, assembling, and calibrating. This area
          will be ready soon.
        </p>
