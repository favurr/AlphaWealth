				...
				<div className="grid max-w-5xl grid-cols-6 gap-6 p-4">
					<div className="col-span-6 flex flex-col gap-4 pt-5 md:col-span-4">
						...
						<p className="max-w-sm text-sm text-muted-foreground">
							Intelligent financial insights and seamless portfolio optimization.
						</p>
						<div >
							<span className="max-w-sm text-sm font-semibold text-muted-foreground">Disclamer:</span>
							<p className="max-w-sm text-sm text-muted-foreground">
								Investing involves risk, including the possible loss of principal.
								AlphaWealth does not guarantee any specific outcome or profit.
							</p>
						</div>
					</div>
