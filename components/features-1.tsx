...
export default function Features() {
  return (
    <section className="bg-background py-12 md:py-24 dark:bg-transparent">
      <div className="@container mx-auto max-w-5xl px-6">
        <div className="text-center">
          <h2 className="text-balance text-4xl font-semibold lg:text-5xl">
            Trade Smarter. Trade Stronger.
          </h2>
          <p className="mt-4">
            We offer CFD trading on forex, crypto, gold, indices, US stocks, and
            more all with a broker trusted by thousands worldwide. Enjoy
            ultra-low spreads, support across 6 regulated jurisdictions,
            multilingual live assistance, and 24/7 crypto trading.
            <br />
            <span className=" italic ">
              Trading in volatile markets carries significant risk.
            </span>
          </p>
        </div>
        <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-12 grid max-w-sm gap-6 *:text-center">
          <Card className="group shadow-zinc-950/5">
            ...
            <CardContent>
              <p className="text-sm">
                Get a demo account, access step-by-step tutorials, join online
                webinars, and enjoy support from your own dedicated account
                manager.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group shadow-zinc-950/5">
            <CardHeader className="pb-3">
              ...
              <h3 className="mt-6 font-medium">Trade</h3>
            </CardHeader>

            <CardContent>
              <p className="mt-3 text-sm">
                Enjoy tight spreads, superfast trade execution, advanced forex
                trading tools, and top-tier risk protection and security.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group shadow-zinc-950/5">
            <CardHeader className="pb-3">
              ...
              <h3 className="mt-6 font-medium">Invest</h3>
            </CardHeader>

            <CardContent>
              <p className="mt-3 text-sm">
                You don't need to be an experienced trader, choose from many
                strategies, earn when Strategy Managers profit, and stay in full
          ...
          <div className="relative z-10 grid grid-cols-6 gap-3">
            <Card className="relative col-span-full flex overflow-hidden rounded-4xl py-4 lg:col-span-2">
              <CardContent className="relative size-fit px-4 pt-4">
                ...
                <p className="mt-16 px-4">
                  Buy crypto with a debit or credit card, mobile payments, or
                  bank transfers.
                </p>
                <Button className="max-w-fit mt-8" asChild variant={"link"}>
                  <Link href="/buy" className="flex items-center gap-2">
                    <p>Learn more</p> <ArrowRightCircleIcon />
                  </Link>
                </Button>
              </CardContent>
            </Card>
            <Card className="relative col-span-full flex overflow-hidden rounded-4xl py-4 lg:col-span-2">
              <CardContent className="relative size-fit px-4 pt-4">
                ...
                <Button className="max-w-fit mt-12" asChild variant={"link"}>
              ...
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    <h2 className="group-hover:text-secondary-950 text-xl font-semibold text-zinc-800 transition dark:text-white">
