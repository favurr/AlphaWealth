  ...
  return (
    <main className="py-24">
      <div className="mx-auto max-w-7xl px-6 lg:flex lg:items-start lg:gap-12">
        ...
        <article className="prose mx-auto w-full max-w-none lg:w-[65%] prose-a:underline prose-a:text-primary">
          ...
          <section id="getting-started" className="scroll-mt-24">
            ...
            <p>
              Welcome — to buy, sell, or transfer crypto on our platform you'll
              need a verified account. Start by creating an account, then verify
              your email and complete identity verification for higher limits.
            </p>
          </section>
          ...
          <section id="account-verification" className="scroll-mt-24">
            ...
            <p>
              ...
              your registered email and a description of the issue. For account
              locks due to security, our team will guide you through identity
              checks.
            </p>
          </section>
          ...
          <section id="buying-and-deposits" className="scroll-mt-24">
            ...
            <p>
              ...
              instructions, and confirm the transaction. On-chain deposits will
              appear after the required number of confirmations — this varies
              per blockchain and token.
            </p>
            ...
            <p>
              Availability of payment methods varies by country. Some providers
              only support local bank transfers, others support cards in certain
              regions. If you don’t see a method you expect, check the country
              selector during checkout or contact support for alternatives.
            </p>
          </section>
          ...
          <section id="security" className="scroll-mt-24">
            ...
            <p>
              ...
              actions and require additional verification to protect your funds.
            </p>
          </section>
          ...
          <section id="kyc-and-compliance" className="scroll-mt-24">
            ...
            <p>
              ...
              selected services. We will prompt for identity verification where
              required.
            </p>
          </section>
          ...
          <section id="troubleshooting" className="scroll-mt-24">
            ...
            <p>
              ...
              confirmations. If you believe funds were sent but not credited,
              open a support ticket with the TXID.
            </p>
